...
func main() {
	// #1: Create a string slice: `names` with a length and capacity of 5, and print it.
	names := make([]string, 5)
	...
	// #3: Append the new elements to the beginning of the names slice instead:
	//     ["einstein", "tesla", "aristo" "" ""]
	...
	//     Doing so should not change any elements of the `sliced` slice.
	sliced := clone[1:4:4]
